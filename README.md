...
Having found a difference overall, we wish to know which diets are
different. As before, we use `adonispost()` and tell it to run pairwise
comparisons of diet by setting `which = diet`.
